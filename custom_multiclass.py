...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 6  # Background + 6 classes (piring, tahu bacem, tempe bacem, tahu goreng, tempe goreng, roti tawar)
...
class CustomDataset(utils.Dataset):
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("makanan", 2, "tahu bacem")
        self.add_class("makanan", 3, "tempe bacem")
        self.add_class("makanan", 4, "tahu goreng")
        self.add_class("makanan", 5, "tempe goreng")
        self.add_class("makanan", 6, "roti tawar")

        # Train or validation dataset?
        assert subset in ["train", "val"]
        dataset_dir = '/content/drive/My Drive/My Research/T h e s i s/%s' % (os.path.join(dataset_dir, subset))
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        return mask.astype(np.bool), class_array.astype(np.int32)
...
class CustomConfig(Config):
    ...
    # Number of classes (including background)
    NUM_CLASSES = 1 + 6  # Background + 9 classes (piring, tahu bacem, tempe bacem, tahu goreng, tempe goreng, roti tawar)
