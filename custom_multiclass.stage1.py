...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 6  # Background + 5 classes (rear bump, front bump, headlamp, door, hood)
...
class CustomDataset(utils.Dataset):
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("makanan", 1, "lele")
        self.add_class("makanan", 2, "kembung")
        self.add_class("makanan", 3, "piring")
        self.add_class("makanan", 4, "nasi")
        self.add_class("makanan", 5, "tahu")
        self.add_class("makanan", 6, "tempe")
