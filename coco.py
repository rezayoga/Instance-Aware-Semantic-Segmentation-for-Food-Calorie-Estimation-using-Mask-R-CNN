...
class CocoDataset(mrcnn.utils.Dataset):
...
def evaluate_coco(model, dataset, coco, eval_type="bbox", limit=0, image_ids=None):
    ...
    for i, image_id in enumerate(image_ids):
        ...
        # Run detection
        t = time.time()
        r = mrcnn.model.detect([image], verbose=0)[0]
...
if __name__ == '__main__':
    ...
    if args.model.lower() == "coco":
        ...
        model_path = mrcnn.model.find_last()[1]
    elif args.model.lower() == "imagenet":
        # Start from ImageNet trained weights
        model_path = mrcnn.model.get_imagenet_weights()
    else:
        model_path = args.model

    # Load weights
    print("Loading weights ", model_path)
    mrcnn.model.load_weights(model_path, by_name=True)
    ...
    if args.command == "train":
        ...
        mrcnn.model.train(dataset_train, dataset_val,
        ...
        evaluate_coco(mrcnn.model, dataset_val, coco, "bbox", limit=int(args.limit))
    else:
