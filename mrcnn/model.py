...
wandb.init(project="my-thesis-food-image-calories-based-on-instance-segmentation")
...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            keras.callbacks.TensorBoard(log_dir=self.log_dir,
                                        histogram_freq=0, write_graph=True, write_grads=True, write_images=True, #update_freq='batch'
                                        ),
            keras.callbacks.ModelCheckpoint(self.checkpoint_path,
                                            verbose=1, save_weights_only=True),
            WandbCallback(save_weights_only=True, log_weights=True),
        ]
